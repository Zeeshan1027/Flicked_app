...
final mainPageDateControllerProvider =
    StateNotifierProvider<MainPageDataController>((ref) {
  return MainPageDataController();
});

final slectedMoviePosterUrlProvider = StateProvider<String>((ref) {
  final _movies = ref.watch(mainPageDateControllerProvider.state).movies;
...
class MainPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ScopedReader watch) {
    ...
    _mainPageDataController = watch(mainPageDateControllerProvider);
    _mainPageData = watch(mainPageDateControllerProvider.state);
    _selectedMoviePosterURL = watch(slectedMoviePosterUrlProvider);
